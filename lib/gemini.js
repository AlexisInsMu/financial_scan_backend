...
const analisisGeneralSchema = {
  type: SchemaType.OBJECT,
  properties: {
    resumen_ejecutivo: { type: SchemaType.STRING, description: "Resumen ejecutivo del análisis, debe no debe de ser mayor a 3 parrafos sobre un telefono en vertical donde diga dependiendo del score si somos " },
    diagnostico: {
      type: SchemaType.OBJECT,
      properties: {
        nivel_actual: { 
    ...
    mensaje_motivacional: {
      type: SchemaType.STRING,
      description: "Un mensaje corto y motivacional para el usuario."
    }
  },
